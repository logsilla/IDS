...
//
// On Mon Jun 14 13:16:01 -03 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkNetwork(CLK,
  ...
  wire WILL_FIRE_RL_action_l365c33,
       WILL_FIRE_RL_action_l383c41,
  ...
  wire MUX_ip$activate_1__SEL_1,
       ...
       MUX_state_mkFSMstate$write_1__SEL_12,
       ...
       MUX_state_mkFSMstate$write_1__SEL_6,
  ...
  wire [15 : 0] checksum__h57753,
		...
		x__h70159,
		x__h70245;
  wire NOT_abort_1_whas__77_99_OR_NOT_abort_1_wget__7_ETC___d608,
       ...
       tx_ready_09_AND_NOT_abort_1_whas__77_99_OR_NOT_ETC___d617,
       tx_ready_09_AND_NOT_abort_1_whas__77_99_OR_NOT_ETC___d621,
       tx_ready_09_AND_start_wire_1_whas__80_AND_star_ETC___d614;
  ...
  // rule RL_action_l365c33
  assign WILL_FIRE_RL_action_l365c33 =
	     NOT_abort_1_whas__77_99_OR_NOT_abort_1_wget__7_ETC___d608 &&
	     (tx_ready_09_AND_start_wire_1_whas__80_AND_star_ETC___d614 ||
	      tx_ready_09_AND_NOT_abort_1_whas__77_99_OR_NOT_ETC___d617 ||
	      tx_ready_09_AND_NOT_abort_1_whas__77_99_OR_NOT_ETC___d621) ;
  ...
  // rule RL_action_l383c41
  assign WILL_FIRE_RL_action_l383c41 =
  ...
  assign MUX_ip$activate_1__SEL_1 =
	     MUX_state_mkFSMstate$write_1__SEL_5 && i_65_ULE_8___d173 ;
  ...
  assign MUX_state_mkFSMstate$write_1__SEL_6 =
	     i == 32'd0 &&
	     ip_nextProtocol__1_EQ_0x6_2_AND_ip_version__4__ETC___d212 &&
	     (state_mkFSMstate == 4'd3 || state_mkFSMstate == 4'd4) ;
  ...
  assign MUX_state_mkFSMstate$write_1__SEL_11 =
	     ...
	     (state_mkFSMstate == 4'd3 || state_mkFSMstate == 4'd4) ||
	     last && state_mkFSMstate == 4'd9 ;
  assign MUX_state_mkFSMstate$write_1__SEL_12 =
	     (eth$ethType != 16'h0800 ||
	      eth_topheader_20_BITS_11_TO_8_21_ULT_5___d122) &&
	     eth$ethType != 16'h86DD &&
	     !last &&
  ...
  assign state_1_set_pw$whas =
	     WILL_FIRE_RL_action_l383c41 || WILL_FIRE_RL_action_l365c33 ;
  ...
  // register state_1_mkFSMstate
  assign state_1_mkFSMstate$D_IN = WILL_FIRE_RL_action_l365c33 ? 3'd1 : 3'd2 ;
  assign state_1_mkFSMstate$EN =
	     WILL_FIRE_RL_action_l365c33 || WILL_FIRE_RL_action_l383c41 ;
  ...
  // register state_mkFSMstate
  always@(MUX_state_mkFSMstate$write_1__SEL_2 or
	  state_mkFSMstate or
	  MUX_state_mkFSMstate$write_1__SEL_4 or
	  MUX_state_mkFSMstate$write_1__SEL_5 or
	  MUX_state_mkFSMstate$write_1__SEL_6 or
	  i_65_EQ_0_66_AND_ip_nextProtocol__1_EQ_0x6_2_A_ETC___d288 or
	  MUX_state_mkFSMstate$write_1__SEL_8 or
	  MUX_state_mkFSMstate$write_1__SEL_9 or
	  MUX_state_mkFSMstate$write_1__SEL_10 or
	  MUX_state_mkFSMstate$write_1__SEL_11 or
	  MUX_state_mkFSMstate$write_1__SEL_12 or
	  MUX_state_mkFSMstate$write_1__SEL_13)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_state_mkFSMstate$write_1__SEL_2: state_mkFSMstate$D_IN = 4'd1;
      state_mkFSMstate == 4'd1: state_mkFSMstate$D_IN = 4'd2;
      MUX_state_mkFSMstate$write_1__SEL_4: state_mkFSMstate$D_IN = 4'd3;
      MUX_state_mkFSMstate$write_1__SEL_5: state_mkFSMstate$D_IN = 4'd4;
      MUX_state_mkFSMstate$write_1__SEL_6: state_mkFSMstate$D_IN = 4'd5;
      i_65_EQ_0_66_AND_ip_nextProtocol__1_EQ_0x6_2_A_ETC___d288:
	  state_mkFSMstate$D_IN = 4'd6;
      MUX_state_mkFSMstate$write_1__SEL_8: state_mkFSMstate$D_IN = 4'd7;
      MUX_state_mkFSMstate$write_1__SEL_9: state_mkFSMstate$D_IN = 4'd8;
      MUX_state_mkFSMstate$write_1__SEL_10: state_mkFSMstate$D_IN = 4'd9;
      MUX_state_mkFSMstate$write_1__SEL_11: state_mkFSMstate$D_IN = 4'd10;
      MUX_state_mkFSMstate$write_1__SEL_12: state_mkFSMstate$D_IN = 4'd11;
      MUX_state_mkFSMstate$write_1__SEL_13: state_mkFSMstate$D_IN = 4'd12;
  ...
  assign eth$parser_d =
	     { data,
	       ...
	       rx_data[39:32],
	       rx_data[47:40] } ;
  assign eth$EN_parser = MUX_state_mkFSMstate$write_1__SEL_2 ;
  assign eth$EN_activate =
	     state_mkFSMstate == 4'd1 || MUX_state_mkFSMstate$write_1__SEL_2 ;
  ...
  assign filter$EN_getToSend = WILL_FIRE_RL_action_l365c33 ;
  ...
  assign ip$EN_parser =
	     MUX_state_mkFSMstate$write_1__SEL_5 ||
	     MUX_state_mkFSMstate$write_1__SEL_4 ;
  assign ip$EN_versionIHL = MUX_state_mkFSMstate$write_1__SEL_4 ;

  // submodule tcp
  assign tcp$activate_v = !MUX_state_mkFSMstate$write_1__SEL_9 ;
  ...
  assign tcp$EN_parser =
	     ...
	     i_65_EQ_0_66_AND_ip_nextProtocol__1_EQ_0x6_2_A_ETC___d288 ||
	     MUX_state_mkFSMstate$write_1__SEL_6 ;
  assign tcp$EN_pairOrodd = MUX_state_mkFSMstate$write_1__SEL_6 ;
  assign tcp$EN_headerPair =
	     MUX_state_mkFSMstate$write_1__SEL_6 && !eth_topheader[8] ;
  assign tcp$EN_headerOdd =
	     MUX_state_mkFSMstate$write_1__SEL_6 && eth_topheader[8] ;
  ...
  assign IF_eth_ethType__9_EQ_0x86DD_7_AND_ip_nextProto_ETC___d63 =
	     (eth$ethType == 16'h86DD && ip$nextProtocol == 8'h06 &&
		  ...
		  294'd0) ;
  assign NOT_abort_1_whas__77_99_OR_NOT_abort_1_wget__7_ETC___d608 =
  ...
  assign ip_nextProtocol__1_EQ_0x6_2_AND_ip_version__4__ETC___d283 =
	     ...
	     (ip$version == 4'd4 && ip4_checksum == 16'hFFFF ||
	      ip$version == 4'd6) &&
	     last ;
  assign tx_ready_09_AND_NOT_abort_1_whas__77_99_OR_NOT_ETC___d617 =
	     tx_ready && state_1_mkFSMstate == 3'd1 ;
  assign tx_ready_09_AND_NOT_abort_1_whas__77_99_OR_NOT_ETC___d621 =
	     tx_ready && state_1_mkFSMstate == 3'd2 ;
  assign tx_ready_09_AND_start_wire_1_whas__80_AND_star_ETC___d614 =
	     tx_ready && start_wire_1$whas && state_1_mkFSMstate == 3'd0 ;
  assign v__h2767 =
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_10 &&
	  (MUX_state_mkFSMstate$write_1__SEL_11 ||
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 320, column 73: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l320c73] and\n  [RL_action_l322c65, RL_action_l336c57, RL_action_l338c49] ) fired in the\n  same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_11 &&
	  (MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 322, column 65: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l322c65] and\n  [RL_action_l336c57, RL_action_l338c49] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_12 &&
	  MUX_state_mkFSMstate$write_1__SEL_13)
	$display("Error: \"Network.bsv\", line 336, column 57: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l336c57] and\n  [RL_action_l338c49] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (running &&
	  abort_whas__3_AND_abort_wget__4_5_OR_state_mkF_ETC___d565 &&
	  !start_reg)
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_2 &&
	  (state_mkFSMstate == 4'd1 || MUX_state_mkFSMstate$write_1__SEL_4 ||
	   MUX_state_mkFSMstate$write_1__SEL_5 ||
	   MUX_state_mkFSMstate$write_1__SEL_6 ||
	   i_65_EQ_0_66_AND_ip_nextProtocol__1_EQ_0x6_2_A_ETC___d288 ||
	   MUX_state_mkFSMstate$write_1__SEL_8 ||
	   ...
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 174, column 25: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l174c25] and\n  [RL_action_l181c25, RL_action_l194c41, RL_action_l211c49, RL_action_l250c65,\n  RL_action_l274c57, RL_action_l291c65, RL_action_l300c65, RL_action_l320c73,\n  RL_action_l322c65, RL_action_l336c57, RL_action_l338c49] ) fired in the same\n  clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (MUX_state_mkFSMstate$write_1__SEL_4 ||
	   ...
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 181, column 25: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l181c25] and\n  [RL_action_l194c41, RL_action_l211c49, RL_action_l250c65, RL_action_l274c57,\n  RL_action_l291c65, RL_action_l300c65, RL_action_l320c73, RL_action_l322c65,\n  RL_action_l336c57, RL_action_l338c49] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_4 &&
	  (MUX_state_mkFSMstate$write_1__SEL_5 ||
	   MUX_state_mkFSMstate$write_1__SEL_6 ||
	   i_65_EQ_0_66_AND_ip_nextProtocol__1_EQ_0x6_2_A_ETC___d288 ||
	   MUX_state_mkFSMstate$write_1__SEL_8 ||
	   ...
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 194, column 41: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l194c41] and\n  [RL_action_l211c49, RL_action_l250c65, RL_action_l274c57, RL_action_l291c65,\n  RL_action_l300c65, RL_action_l320c73, RL_action_l322c65, RL_action_l336c57,\n  RL_action_l338c49] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_5 &&
	  (MUX_state_mkFSMstate$write_1__SEL_6 ||
	   i_65_EQ_0_66_AND_ip_nextProtocol__1_EQ_0x6_2_A_ETC___d288 ||
	   MUX_state_mkFSMstate$write_1__SEL_8 ||
	   MUX_state_mkFSMstate$write_1__SEL_9 ||
	   ...
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 211, column 49: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l211c49] and\n  [RL_action_l250c65, RL_action_l274c57, RL_action_l291c65, RL_action_l300c65,\n  RL_action_l320c73, RL_action_l322c65, RL_action_l336c57, RL_action_l338c49]\n  ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_6 &&
	  (i_65_EQ_0_66_AND_ip_nextProtocol__1_EQ_0x6_2_A_ETC___d288 ||
	   MUX_state_mkFSMstate$write_1__SEL_8 ||
	   MUX_state_mkFSMstate$write_1__SEL_9 ||
	   MUX_state_mkFSMstate$write_1__SEL_10 ||
	   ...
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 250, column 65: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l250c65] and\n  [RL_action_l274c57, RL_action_l291c65, RL_action_l300c65, RL_action_l320c73,\n  RL_action_l322c65, RL_action_l336c57, RL_action_l338c49] ) fired in the same\n  clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (MUX_state_mkFSMstate$write_1__SEL_8 ||
	   ...
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 274, column 57: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l274c57] and\n  [RL_action_l291c65, RL_action_l300c65, RL_action_l320c73, RL_action_l322c65,\n  RL_action_l336c57, RL_action_l338c49] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_8 &&
	  (MUX_state_mkFSMstate$write_1__SEL_9 ||
	   MUX_state_mkFSMstate$write_1__SEL_10 ||
	   MUX_state_mkFSMstate$write_1__SEL_11 ||
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 291, column 65: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l291c65] and\n  [RL_action_l300c65, RL_action_l320c73, RL_action_l322c65, RL_action_l336c57,\n  RL_action_l338c49] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_state_mkFSMstate$write_1__SEL_9 &&
	  (MUX_state_mkFSMstate$write_1__SEL_10 ||
	   MUX_state_mkFSMstate$write_1__SEL_11 ||
	   MUX_state_mkFSMstate$write_1__SEL_12 ||
	   MUX_state_mkFSMstate$write_1__SEL_13))
	$display("Error: \"Network.bsv\", line 300, column 65: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l300c65] and\n  [RL_action_l320c73, RL_action_l322c65, RL_action_l336c57, RL_action_l338c49]\n  ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l365c33 && WILL_FIRE_RL_action_l383c41)
	$display("Error: \"Network.bsv\", line 365, column 33: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l365c33] and\n  [RL_action_l383c41] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (running_1 &&
	  abort_1_whas__77_AND_abort_1_wget__78_79_OR_st_ETC___d638 &&
	  !start_reg_1_1)
